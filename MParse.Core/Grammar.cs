...
namespace MParse.Core
{
    public class Grammar
    {
        ...
        public Grammar(IList<Production> productions, IList<GrammarSymbol> symbols, Item augmentedState)
        {
            ...
            if (augmentedState == null)
                throw new ArgumentNullException("augmentedState");
        ...
        /// <summary>
        /// Stores the FIRST sets as we calculate them
        /// so we dont have to do it multiple times for the same symbol.
        /// </summary>
        private readonly Dictionary<GrammarSymbol, List<Terminal>> _firstSetCache;
        /// <summary>
        /// Stores the FOLLOW sets as we calculate them
        /// so we dont have to do it multiple times for the same symbol.
        /// </summary>
        ...
        private IEnumerable<Item> GetClosure(Item item)
        {
        ...
        /// <param name="items"></param>
        /// <returns></returns>
        private IList<Item> GetClosure(IEnumerable<Item> items)
        {
