...
{
    public class ProductionRHSListVisitor : IParseTreeVisitor
    {
        public List<List<string>> ProductionTails { get; private set; }

        public ProductionRHSListVisitor()
        {
            ProductionTails = new List<List<string>>();
        }
        ...
        {
            var itemListVisitor = new ItemListVisitor();
            nonTerminal.T0.AcceptVisitor(itemListVisitor);
            ProductionTails.Add(itemListVisitor.Items);
        }
